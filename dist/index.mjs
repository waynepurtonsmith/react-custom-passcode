...
const PasscodeContext = createContext(void 0);
const PasscodeProvider = ({ totalFields, type, defaultValue, autoFocus, children, onUpdate }) => {
	var _currentPasscode$;
	const [currentPasscode, setCurrentPasscode] = useState(typeof defaultValue === "string" ? removeInvalidCharacters(defaultValue, type).slice(0, totalFields).split("") : []);
	const [currentFocusedIndex, setCurrentFocusedIndex] = useState(autoFocus && !(currentPasscode === null || currentPasscode === void 0 || (_currentPasscode$ = currentPasscode[0]) === null || _currentPasscode$ === void 0 ? void 0 : _currentPasscode$.length) ? 0 : -1);
	...
	return /* @__PURE__ */ jsx(PasscodeContext.Provider, {
		value: providerValue,
		children
	});
};
...
const Field = (_ref) => {
	...
	if (Renderer) return /* @__PURE__ */ jsx(Renderer, _objectSpread2(_objectSpread2({}, mergedProps), {}, { index }));
	return /* @__PURE__ */ jsx("input", _objectSpread2(_objectSpread2({}, mergedProps), {}, { ref: fieldRef }));
};
...
const Passcode = ({ defaultValue, fields, name, id, renderer, type, autoFocus, autoTab, required, onUpdate }) => {
	...
	return /* @__PURE__ */ jsx(PasscodeProvider, {
		totalFields,
		type,
		defaultValue,
		autoFocus,
		onUpdate,
		children: passcodeFields.map((field, index) => /* @__PURE__ */ jsx(Fragment, { children: /* @__PURE__ */ jsx(Field_default, _objectSpread2({
			renderer,
			index,
			fieldType: type,
			autoTab,
...
//#endregion
export { Field_default as Field, Passcode_default as Passcode };